    ...
    <form action="{{url('/education')}}" method="post">
      ...
      <div class="input-group mx-auto" style="width: 500px; ">
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" placeholder="What you studied" class="form-control" name="profession" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
        </div>
        <div class="input-group mb-3">
          <div class="input-group-prepend">
            <span class="input-group-text" id="inputGroup-sizing-default">Establishment</span>
          </div>
          <input type="text" placeholder="Where you studied" class="form-control" name="establishment" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
        </div>
